...
type AppIDMsg struct {
	Cid   int64  `protobuf:"varint,1,opt,name=cid" json:"cid,omitempty"`
	AppID []byte `protobuf:"bytes,2,opt,name=appID,proto3" json:"appID,omitempty"`
}

func (m *AppIDMsg) Reset()                    { *m = AppIDMsg{} }
func (m *AppIDMsg) String() string            { return proto1.CompactTextString(m) }
func (*AppIDMsg) ProtoMessage()               {}
func (*AppIDMsg) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }

type AppIDRet struct {
	R bool   `protobuf:"varint,1,opt,name=r" json:"r,omitempty"`
	M []byte `protobuf:"bytes,2,opt,name=m,proto3" json:"m,omitempty"`
}

func (m *AppIDRet) Reset()                    { *m = AppIDRet{} }
func (m *AppIDRet) String() string            { return proto1.CompactTextString(m) }
func (*AppIDRet) ProtoMessage()               {}
func (*AppIDRet) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func init() {
	...
	proto1.RegisterType((*AppIDMsg)(nil), "proto.AppIDMsg")
	proto1.RegisterType((*AppIDRet)(nil), "proto.AppIDRet")
...
type RpcClient interface {
	...
	// 用户设置相关
	SetAppID(ctx context.Context, in *AppIDMsg, opts ...grpc.CallOption) (*AppIDRet, error)
	// 用户订阅相关
...
func (c *rpcClient) SetAppID(ctx context.Context, in *AppIDMsg, opts ...grpc.CallOption) (*AppIDRet, error) {
	out := new(AppIDRet)
	err := grpc.Invoke(ctx, "/proto.Rpc/SetAppID", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RpcServer interface {
	...
	// 用户设置相关
	SetAppID(context.Context, *AppIDMsg) (*AppIDRet, error)
	// 用户订阅相关
...
func _Rpc_SetAppID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppIDMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RpcServer).SetAppID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Rpc/SetAppID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RpcServer).SetAppID(ctx, req.(*AppIDMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
